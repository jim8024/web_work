...
<%
	...
	//3.수정폼을 응답하기(이미 저장된 정보 출력해주고 그리고 수정)
...
<body>
	<div class="container">
		...
		<form action="update.jsp">
			...
			<div class="mb-2">
				<label class="form-label" for="container">내용</label>
				<textarea class="form-control" name="content" id="content"  rows="10"><%=dto.getContent() %></textarea>
			</div>
			<button onclick="submitContents(this)" class="btn btn-primary" type="submit">수정 확인</button>
